...
cargo xtask vm up <image> [--desktop <kde|gnome|xfce|cinnamon>] [--session-type <x11|wayland>] [--screens <n>]   # An interactive guest, with the current binaries in it
